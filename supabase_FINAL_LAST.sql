-- Atlantis MC — FINAL Supabase migration
-- Run once in Supabase SQL Editor. Keeps existing users/messages.
...
-- Anonymous chat needs nullable user_id.
alter table public.messages
...
-- IMPORTANT: previous versions used both argument orders.
-- Remove the text,text function and recreate it with the exact named arguments
-- used by the final auth.js.
